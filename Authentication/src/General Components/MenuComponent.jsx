    ...
    <div className="relative">
      <div className="md:block">
        ...
        <Link to={"/Dashboard"}>
          {menu && (
            <button
              className={`relative mt-2 w-[80%] sm:w-88 h-8 md:shadow rounded-lg mx-4`}
            >
              <svg
              ...
              <span className={`hidden sm:block lg:block md:mr-8 text-${color1}`}>
                Dashboard
              </span>
            </button>
          )}
          ...
          <Link to={"/Users"}>
            {menu && (
              <button className={`relative h-8 mx-4 w-[80%] sm:w-88  mt-5 `}>
                ...
                <span
                  className={`hidden sm:block lg:block md:mr-20  md:ml-4 text-${color2}`}
                >
                  User's
                </span>
              </button>
        ...
        {menu && (
          <Link to={"/Task"}>
            <button className={`relative h-8 mx-4 w-[80%] sm:w-88 mt-5 `}>
              ...
              <span className={`hidden sm:block lg:block ml-2 md:mr-20 text-${color3}`}>
                Task
              </span>
            </button>
          </Link>
